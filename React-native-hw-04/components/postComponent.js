    ...
    return(
        <View>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('Comments',{img})}>
                <Image source={require("../screens/Images/Shape.jpg")} style={{width:24,height:24,color:'#BDBDBD'}}/>
                <Text style={styles.commentText}>0</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=>{navigation.navigate("Map", {location})}}>
            <Image source={require("../screens/Images/map-pin.jpg")}style={{width:24,height:24,color:'#BDBDBD'}}/>
